	...
	<div id="content-header">
		<div id="breadcrumb">
			<a href="<%=basePath%>admin/indexs" title="主页"
				class="tip-bottom"><i class="icon-home"></i>主页</a> <a title="商品时间信息统计"
				class="tip-bottom">商品时间信息统计</a>
		</div>
	</div>
	<div id="chart1" style="width:1000px;height:170px;display: inline-block" >
		<table class="table table-bordered" style="margin: auto;width:700px;">
	  <caption ><strong>各月相关商品数量</strong></caption>
		  <thead>
		    <tr>
		      <th>状态</th>
		      <th>总数量</th>
